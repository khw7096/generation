...
--	out:Width( 512 )							-- change the output resolution
--	out:Height( 256 )
	...
	-- lets generate some sane folders
	-- clipPath = "clip_" .. i .. "\\"				-- make a path for clip
	--out:Filename( pathOut ..tlist[i].."_".."item_" .. i .. ".mov" )  --clipPath ..
